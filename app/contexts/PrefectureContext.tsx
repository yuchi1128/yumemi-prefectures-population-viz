...
type PrefectureContextType = {
  ...
  setSelectedPrefectures: React.Dispatch<React.SetStateAction<Record<number, boolean>>>;
  selectedDataType: string;
  setSelectedDataType: React.Dispatch<React.SetStateAction<string>>;
};

const PrefectureContext = createContext<PrefectureContextType | undefined>(undefined);

export function PrefectureProvider({ children }: { children: React.ReactNode }) {
